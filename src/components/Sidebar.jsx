    ...
    <header>
      <aside className="sidebar_bg h-screen py-3 w-20 fixed z-10">
        <div className="flex flex-col items-center">
          ...
          <div class="group flex h-14 w-14 transform items-center justify-center rounded-full bg-primaryBlue transition-transform hover:scale-110 mt-6 relative cursor-pointer">
